...
> You might freeze at config debugging questions because you'd never practiced this format. These 10 problems train you on the exact pattern: **read client complaint → read code → find and fix the issue → explain why.**
...
## Problem 1: Hiring Threshold (Similar to Common Config Questions)
